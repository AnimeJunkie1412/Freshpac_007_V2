...
const printStyles = `
  ...
  @media print {
    ...
    .delivery-print-page:last-child {
  ...
  @media screen {
    ...
    .delivery-print-page + .delivery-print-page {
      margin-top: 24px;
    }
  }
`;

export default async function BatchDeliveryNotesPrintPage({
  searchParams
}: {
  searchParams?: {
    q?: string;
  ...
  return (
    <main className="min-h-screen bg-freshpac-cream px-4 py-5 text-freshpac-charcoal print:bg-white print:px-0 print:py-0">
      ...
      <div className="delivery-batch-shell mx-auto">
...
function DeliveryNoteSheet({ order }: { order: PrintableOrder }) {
  ...
  return (
    <section className="delivery-print-page">
      <div className="delivery-sheet rounded-3xl border border-freshpac-panel bg-white p-6 shadow-panel">
